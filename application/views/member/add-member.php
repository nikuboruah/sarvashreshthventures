    ...
    <div class="row mt-3">
        <div class="col-md-4">
            <div class="form-group">
                ...
                <input type="text" placeholder="Sponsor ID" value="<?= $this->session->userdata('aiplUserId') ?>" name="sponsorid" id="sponsorid" class="form-control">
...
function addNewMember() {
    ...
    $.ajax({
        url: '<?php echo base_url('member/add_new_member_user') ?>',
        method: 'POST',
        data: d,
