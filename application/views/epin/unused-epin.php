                ...
                <table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_1">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?= date('d M Y, h:i A', strtotime($epin->transfered_date)) ?></td>
                            <td><button id="<?= $epin->epin.'/'.$this->session->userdata('aiplUserId') ?>" onclick="registrationWithEPIN(this)" class="btn btn-success">JOIN</button></td>
