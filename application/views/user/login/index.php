                        ...
                        <div class="col-lg-4 mx-auto">
                            <div class="card">
                                ...
                                <div class="card-body pt-0">    
									...
									?>                                 
                                    <form class="my-2" action="<?php echo site_url('authentication/processLogin'); ?>"
                                method="post">           
                                        <div class="form-group mb-2">
                                            <label class="form-label" for="email">Member ID</label>
                                            <input type="text" class="form-control" id="email" name="email" placeholder="Enter Member ID">                               
                                        </div><!--end form-group--> 
                                        ...
                                        <div class="form-group row mt-3">
                                            ...
                                            <div class="col-sm-6 text-end">
                                                <a href="<?php echo base_url('/') ?>" class="text-muted font-13"><i class="dripicons-lock"></i> Forgot password?</a>                                    
                                            </div><!--end col--> 
                                        </div><!--end form-group--> 
                                    ...
                                    <div class="m-3 text-center text-muted">
                                        <p class="mb-0">Don't have an account? <a href="<?php echo base_url('registration') ?>" class="text-primary ms-2"><u>Register Now</u></a></p>
