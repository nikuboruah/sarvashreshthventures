 ...
 <div class="pb-[70px]">
     <div class="container">
        <?php if($cartItems == 0){ ?>
         ...
         <form action="<?php echo base_url('activate_member_by_bv') ?>" method="post" enctype="multipart/form-data">
...
$(document).ready(function() {
    ...
    // BV Package check AJAX
    let bv_amt = $('#tbv').val();

    $.ajax({
        url: '<?php echo base_url('find_package_for_activation') ?>',
        method: 'POST',
        data: {
            bv: bv_amt
        },
