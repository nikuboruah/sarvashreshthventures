                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row justify-content-center align-items-center" style="margin-top: 1em;">
                                <div class="col-lg-6 mb-3">
                                    <div class="card">
                                        <div class="card-header">
                                            <h4 class="card-title">Account Password</h4>
                                        </div>
                                        <div class="card-body">
                                            <form action="<?php echo site_url('settings/changePassword'); ?>"
                                                ...
                                                <div class="mb-3">
                                                    <input type="password" required id="password" name="new_password"
                                                        class="form-control"
                                                ...
                                                <button type="submit" name="change" id="panelPassword"
                                                    class="btn btn-primary">Change account password</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-6 mb-3">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form action="<?php echo site_url('settings/changeTransactionPassword'); ?>"
                                                method="post">
                                                <div class="mb-3">
                                                ...
                                                <div class="mb-3">
                                                    <input type="password" required id="t__password" name="t__password"
                                                        class="form-control"
                                                        value="<?php echo set_value('new_password'); ?>"
                                                        placeholder="New Password">
                                                    <span id="t_msg"></span>
