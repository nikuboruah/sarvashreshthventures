    ...
    <div class="page-content-tab">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="page-title-box">
                        <div class="float-end">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="#">Team & networks</a></li>
                                <li class="breadcrumb-item"><a href="#">Tree View</a></li>
                            </ol>
                        </div>
                        <h4 class="page-title">Team & networks</h4>
                    </div>
                    <!--end page-title-box-->
                </div>
                <!--end col-->
                                    ...
                                    { ?>
                                                ...
                                                <li><a href="javascript:void(0);">
                                                        <div class="member-view-box">
                                                            <div class="member-image"
                                                                style="margin-left:auto;margin-right:auto;">
                                                                <img src="<?= base_url("../uploads/profile/images.png") ?>"
                                                                    alt="Member" style="border-radius:50%">
                                    ...
                                    { ?>
                                                <li><a href="javascript:void(0);">
                                                        <div class="member-view-box">
                                                            <div class="member-image"
                                                                style="margin-left:auto;margin-right:auto;">
                                                                <img src="<?php echo base_url("../uploads/profile/images.png") ?>"
                                                                    alt="Member" style="border-radius:50%">
        ...
        $(function() {
            ...
            $('.genealogy-tree li').on('click', function(e) {
                ...
                if (children.is(":visible")) children.hide('fast').removeClass(
                    'active');
