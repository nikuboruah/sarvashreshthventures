    ...
    <div class="col-lg-12 text-right">
        <div class="kt-portlet__foot">
            <div class="kt-form__actions">
                <button type="button" name="addstaff" class="btn btn-primary" onclick="deduct()">Deduct</button>
            </div>
        </div>
    </div>
</div>
...
<script>
    deduct=function()
    {
        ...
        if(!confirm("Deduction in progress.Press Ok to continue.")) return;
        var d={
